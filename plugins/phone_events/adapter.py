...
_PHONE_DATA_CHANNEL_PROMPT = (
    ...
    "chat context is needed, so visible image messages are available to vision. "
    "If an image thumbnail is too small to understand, inspect the returned page "
    "screenshot before opening only the clearly identified image. Any request "
