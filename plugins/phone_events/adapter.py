...
_PHONE_DATA_CHANNEL_PROMPT = (
    ...
    "chat context is needed. For voice/audio messages pass transcribe_voice=true with max_voice=3. "
    ...
    "For image understanding, pass open_images=true and max_images no greater than 3: "
    "the tool opens only clearly identified "
