...
RELEASE_APK_PATH="${SCRIPT_DIR}/helper-apk/releases/hermes-phone-agent-v0.2.1.apk"
...
if [[ ! -f "$APK_PATH" ]]; then
    ...
    echo "     cp app/build/outputs/apk/debug/app-debug.apk releases/hermes-phone-agent-v0.2.1.apk"
    exit 1
fi
